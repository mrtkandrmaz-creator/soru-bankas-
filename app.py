...
TURK_MUTFAGI_YORESEL = {
    ...
    "Saray Mutfağı": {"yemek": "Hünkar Beğendi", "ipucu": "Közlenmiş patlıcanların tereyağı ve unla kavrulup sütle püre haline getirilmesi ve üzerine kuşbaşı kuzu eti eklenmesiyle yapılır."},
    "Saray Mutfağı": {"yemek": "Mutancana", "ipucu": "Kuzu etinin kuru üzüm, badem, hurma, erik kurusu ve bal ile tatlandırılarak tencerede kısık ateşte pişirildiği saray yemeğidir."},
    "Saray Mutfağı": {"yemek": "Kavun Dolması", "ipucu": "Bütün bir kavunun tepesinin kesilip içi boşaltıldıktan sonra pirinç, kıyma, badem ve kuş üzümü harcıyla doldurularak fırınlanmasıdır."},
    "Saray Mutfağı": {"yemek": "Keşkül-ü Fukara", "ipucu": "Badem tozu, toz şeker, nişasta ve sütün kaynatılmasıyla yapılan, üzerine fıstık serpiştirilerek sunulan saray sütlü tatlısıdır."},
    "Saray Mutfağı": {"yemek": "Zerde", "ipucu": "Pirincin suyla haşlanıp şeker, safran, gül suyu ve çam fıstığı ile tatlandırılmasıyla hazırlanan geleneksel saray tatlı pilavıdır."},
    "Saray Mutfağı": {"yemek": "Demirhindi Şerbeti", "ipucu": "Demirhindi meyvesi, karanfil, tarçın, zencefil ve çeşitli baharatların günlerce suda bekletilip kaynatılmasıyla yapılır."},
    "Saray Mutfağı": {"yemek": "Tavukgöğsü", "ipucu": "Haşlanmış tavuk etinin beyaz liflerinin dövülerek süt, pirinç unu ve damla sakızıyla kazanda muhallebi kıvamına getirilmesidir."},
    "Saray Mutfağı": {"yemek": "Mahmudiye", "ipucu": "Tavuk etinin tarçın, badem, kuru kayısı, kayısı suyu ve bal ile harmanlanarak fırında pişirildiği saray yemeğidir."},
    "Saray Mutfağı": {"yemek": "İmamiye Pilavı", "ipucu": "Kuzu eti, badem, tarçın ve tereyağlı pirinç pilavının özel kaplarda kat kat pişirilerek sunulduğu ihtişamlı yemektir."},
    "Saray Mutfağı": {"yemek": "Keşkek", "ipucu": "Buğday ve kemikli kuzu etinin büyük bakır kazanlarda odun ateşinde ahşap tokmaklarla dövülerek macun kıvamına getirilmesidir."},
    "Saray Mutfağı": {"yemek": "Güllaç", "ipucu": "Mısır nişastasından yapılan ince yufkaların sıcak süt ve şeker karışımıyla ıslatılıp arasına ceviz koyulmasıyla yapılır."},
    "Saray Mutfağı": {"yemek": "Hakiki Badem Ezmesi", "ipucu": "Kabuksuz tatlı bademlerin kaynar suda haşlanıp havanda macun kıvamına gelene kadar şeker ve gül suyuyla dövülmesidir."},
    "Saray Mutfağı": {"yemek": "Sirkencübin", "ipucu": "Bal ve sirkenin belirli oranlarda suyla karıştırılmasıyla yapılan, Osmanlı sarayında mideyi rahatlatmak için içilen şerbettir."},
    "Saray Mutfağı": {"yemek": "Külbastı", "ipucu": "Kuzu budundan çıkarılan ince et dilimlerinin hafifçe dövülüp baharatlanarak mangal telinde veya sac üzerinde pişirilmesidir."},
    "Saray Mutfağı": {"yemek": "Paşa Çorbası", "ipucu": "Kuzu incik eti, pirinç, yoğurt, yumurta sarısı ve limon suyu ile terbiye edilerek yapılan zengin bir saray çorbasıdır."},
    "Saray Mutfağı": {"yemek": "Sübye", "ipucu": "Kurutulmuş kavun çekirdeklerinin öğütülüp su ve şekerle özleştirilmesiyle elde edilen serinletici saray içeceğidir."},
    "Saray Mutfağı": {"yemek": "Ispanak Borani", "ipucu": "Ispanakların sotelenip sarımsaklı süzme yoğurtla karıştırılması, üzerine kızdırılmış tereyağı ve ceviz gezdirilmesidir."},
    "Saray Mutfağı": {"yemek": "Erikli Et", "ipucu": "Kuzu etinin tike doğranıp ekşi mürdüm eriği, soğan ve nane ile birlikte tencerede pişirildiği saray yemeğidir."},
    "Saray Mutfağı": {"yemek": "Kerebiç", "ipucu": "İrmikla yapılan hamurun içi ceviz veya fıstıkla doldurulup fırınlanması ve köven otu köpüğüyle yenmesidir."},
    "Saray Mutfağı": {"yemek": "Saray Helvası", "ipucu": "Unun tereyağında kavrulup pudra şekeriyle harmanlanarak tel tel yapıltıktan sonra sıkıştırılmasıdır."}
}
...
DUNYA_MUTFAGI_LEZZETLER = {
    ...
    "Lübnan": {"yemek": "Lübnan Humus", "ipucu": "Haşlanmış nohutun tahin, sarımsak, zeytinyağı ve limon suyu ile püre haline getirilmesiyle yapılır."},
    "Tayland": {"yemek": "Tayland Pad Thai", "ipucu": "Pirinç eriştesinin yumurta, tofu, fıstık ve özel tamarind sosu ile tavada yüksek ateşte kavrulmasıdır."},
    "Vietnam": {"yemek": "Vietnam Pho", "ipucu": "Uzun saatler kaynatılmış et suyu, pirinç noodle, taze otlar ve et dilimleriyle sunulan aromatik çorbadır."},
    "Fas": {"yemek": "Fas Kuskus / Tajin", "ipucu": "İrmik tanelerinin buharda pişirilmesi ve koni şeklindeki toprak kapta etle haşlanmasıyla yapılır."},
    "Brezilya": {"yemek": "Brezilya Feijoada", "ipucu": "Siyah fasulyenin domuz eti ve sığır eti parçalarıyla birlikte saatlerce kısık ateşte pişirildiği ulusal yemektir."},
    "Arjantin": {"yemek": "Arjantin Asado", "ipucu": "Dana etlerinin özel baharatlar eşliğinde açık ateşte veya mangalda yavaş yavaş pişirilmesidir."},
    "Peru": {"yemek": "Peru Ceviche", "ipucu": "Taze çiğ balık parçalarının limon suyu, kırmızı soğan ve acı biberde marine edilerek pişirilmeden sunulmasıdır."},
    "Amerika Birleşik Devletleri": {"yemek": "ABD Hamburger", "ipucu": "Özel ekmek arasına yerleştirilen kıyma köftesi, marul, domates ve peynir dilimleriyle hazırlanan fast-food ürünüdür."},
    "Almanya": {"yemek": "Almanya Sosis / Bretzel", "ipucu": "Domuz veya sığır etinden yapılan baharatlı sosislerin hardal eşliğinde, düğüm şeklindeki tuzlu ekmekle sunulmasıdır."},
    "Güney Kore": {"yemek": "Güney Kore Kimchi", "ipucu": "Çin lahanası ve turpun sarımsak, zencefil ve kırmızı biber salçası ile fermente edilmesiyle yapılan acılı yan üründür."},
    "Türkiye": {"yemek": "Türkiye Kebap / Lahmacun", "ipucu": "Zırhtan geçirilmiş kıyma etin baharatlarla yoğrularak şişte veya odun ateşinde ince hamur üzerinde pişirilmesidir."},
    "İran": {"yemek": "İran Çölo", "ipucu": "Safranlı ve tereyağlı pirinç pilavının, kuzu eti veya özel kebaplarla servis edilen geleneksel halidir."},
    "İngiltere": {"yemek": "İngiltere Fish and Chips", "ipucu": "Beyaz balık filetolarının mısır unlu hamura batırılarak kızartılması ve yanına patates kızartması ile verilmesidir."},
    "Rusya": {"yemek": "Rusya Borsç", "ipucu": "Pancar kökünün kendine has kırmızı rengini veren, lahana ve et suyuyla yapılan ekşimsi çorbadır."},
    "Ukrayna": {"yemek": "Ukrayna Varenyky", "ipucu": "İnce hamurun içine patates, mantar veya peynir doldurularak haşlanması ve tereyağıyla servis edilmesidir."},
    "İsveç": {"yemek": "İsveç Köftesi", "ipucu": "Dana ve domuz kıymasından yapılan küçük köftelerin kremsi kahverengi sos ve yaban mersini reçeliyle sunulmasıdır."},
    "Macaristan": {"yemek": "Macaristan Gulaş", "ipucu": "Kuşbaşı et, soğan ve bolca tatlı toz kırmızı biberin (paprika) uzun süre tencerede pişirilmesiyle yapılan et yemeğidir."},
    "Polonya": {"yemek": "Polonya Pierogi", "ipucu": "Yarım ay şeklinde kapatılmış, içi patates, peynir veya kıymayla doldurulan haşlanmış hamur mantısıdır."},
    "Gürcistan": {"yemek": "Gürcistan Hachapuri", "ipucu": "Tekne şeklindeki hamurun içine bolca peynir, tereyağı ve çiğ yumurta sarısı koyularak fırınlanmasıdır."},
    "Azerbaycan": {"yemek": "Azerbaycan Piti / Aş", "ipucu": "Kuzu eti, nohut ve kestane gibi malzemelerin özel kaplarda kuyu tandırında veya fırında pişirilmesidir."},
    "Mısır": {"yemek": "Mısır Kişşeri", "ipucu": "Mercimek, makarna, pirinç, nohut ve domates sosunun kızarmış soğanla karıştırılmasıyla yapılan sokak yemeğidir."},
    "Etiyopya": {"yemek": "Etiyopya İnjera", "ipucu": "Teff unundan yapılan, ekşi mayalı, süngerimsi ve büyük ince krep benzeri ekmek üzerine yemeklerin dökülmesiyle yenir."},
    "Küba": {"yemek": "Küba Küba Sandviçi", "ipucu": "Küba ekmeği arasına domuz eti, jambon, peynir, turşu ve hardal koyularak preslenip tost yapılmasıdır."},
    "Kolombiya": {"yemek": "Kolombiya Arepa", "ipucu": "Mısır unundan yapılan hamurun disk şeklinde şekillendirilip ızgarada pişirilmesi ve içine peynir konulmasıdır."},
    "Venezuela": {"yemek": "Venezuela Pabellón Criollo", "ipucu": "Pirinç, siyah fasulye, didiklenmiş sığır eti ve kızarmış muz dilimlerinin bir tabakta sunulmasıdır."},
    "Şili": {"yemek": "Şili Empanada", "ipucu": "İçi kıyma, soğan, zeytin ve haşlanmış yumurta dolgulu hamur kesesinin fırınlanmasıdır."},
    "Endonezya": {"yemek": "Endonezya Nasi Goreng", "ipucu": "Haşlanmış pirincin soya sosu, karides ezmesi, sarımsak ve sebzelerle tavada kızartılmasıdır."},
    "Malezya": {"yemek": "Malezya Nasi Lemak", "ipucu": "Hindistan cevizi sütünde pişirilen pirincin hamsi, yer fıstığı, salatalık ve acı sosla sunulmasıdır."},
    "Filipinler": {"yemek": "Filipinler Adobo", "ipucu": "Tavuz veya domuz etinin soya sosu, sirke, sarımsak ve karabiber içinde marine edilip pişirilmesidir."},
    "Pakistan": {"yemek": "Pakistan Biryani", "ipucu": "Basmati pirinci ve etin karanfil, kakule gibi yoğun baharatlarla kat kat pişirildiği pilav çeşididir."},
    "Bangladeş": {"yemek": "Bangladeş Bhuna Khichuri", "ipucu": "Mercimek ve pirincin et veya sebzeyle birlikte kavrularak yoğun baharatla pişirilmesidir."},
    "Nepal": {"yemek": "Nepal Momo", "ipucu": "İnce hamur içerisine sebze veya kıyma doldurularak buharda pişirilen mantı benzeri yemektir."},
    "Suriye": {"yemek": "Suriye Halep Kebabı", "ipucu": "Zırh kıymasının fıstık, közlenmiş biber ve özel domates sosuyla fırınlanmasıdır."},
    "Irak": {"yemek": "Irak Masgouf", "ipucu": "Nehir balığının ortadan ikiye açılıp özel tuz ve baharatlarla açık ateşte dikey olarak tütsülenerek pişirilmesidir."},
    "Suudi Arabistan": {"yemek": "Suudi Arabistan Kabsa", "ipucu": "Basmati pirinci üzerine kuzu veya tavuk eti ile karanfil, tarçın ve kakule gibi baharatların eklenmesiyle yapılır."},
    "Katar": {"yemek": "Katar Machboos", "ipucu": "Et ve baharatlı pirincin kurutulmuş limon (loomi) aromasıyla uzun süre pişirilmesidir."},
    "Birleşik Arap Emirlikleri": {"yemek": "BAE Al Harees", "ipucu": "Buğday ve etin saatlerce büyük kazanlarda dövülerek püre kıvamına gelene kadar pişirilmesidir."},
    "Fas": {"yemek": "Fas Pastilla", "ipucu": "İnce yufka arasına tatlı ve tuzlu tavuk eti, badem ve tarçın koyularak fırınlanan börek türüdür."},
    "Cezayir": {"yemek": "Cezayir Şakşuka", "ipucu": "Domates, biber, sarımsak ve baharatların tavada pişirilip üzerine yumurta kırılmasıyla yapılır."},
    "Tunus": {"yemek": "Tunus Brik", "ipucu": "İnce yufka içerisine ton balığı, yumurta ve maydanoz koyulup üçgen şeklinde yağda kızartılmasıdır."},
    "Nijerya": {"yemek": "Nijerya Jellof Pirinci", "ipucu": "Pirinçlerin domates salçası, biber, soğan ve et suyunda kırmızı renk alacak şekilde pişirilmesidir."},
    "Gana": {"yemek": "Gana Fufu", "ipucu": "Manyok ve bitki muzunun haşlanıp büyük havuzlarda macun kıvamına gelene kadar dövülmesiyle yapılır."},
    "Kenya": {"yemek": "Kenya Ugali", "ipucu": "Mısır ununun kaynar suya yavaşça dökülerek katı bir hamur kıvamına getirilip elle yenmesidir."},
    "Güney Afrika": {"yemek": "Güney Afrika Bobotie", "ipucu": "Baharatlı kıymanın üzerine yumurtalı süt dökülerek fırınlanan, kuru üzümlü geleneksel yemektir."},
    "Portekiz": {"yemek": "Portekiz Pastel de Nata", "ipucu": "Çıtır milföy benzeri hamur çanağının içine yumurtalı, vanilyalı krema doldurulup fırınlanarak yapılan tatlıdır."},
    "İsviçre": {"yemek": "İsviçre Fondü", "ipucu": "Çeşitli peynirlerin beyaz şarapla eritildiği kapta, ekmek parçalarının batırılarak yenmesidir."},
    "Avusturya": {"yemek": "Avusturya Viyana Usulü Şnitzel", "ipucu": "İnceltilmiş dana etinin un, yumurta ve galeta ununa bulanarak bol yağda kızartılmasıdır."},
    "Belçika": {"yemek": "Belçika Vafli / Patates Kızartması", "ipucu": "Özel döküm demirde pişirilen kareli hamurun üzerine çikolata veya meyve dökülmesiyle yapılır."},
    "Çekya": {"yemek": "Çekya Knedlik", "ipucu": "Mayalı ekmek hamurunun dilimlenerek suda haşlanması ve et yemeklerinin yanında sosla sunulmasıdır."},
    "İrlanda": {"yemek": "İrlanda İrlanda Yahni (Irish Stew)", "ipucu": "Kuzu eti, patates, soğan ve havuçların tencerede suyla uzun süre kaynatılmasıyla yapılır."},
    "Yeni Zelanda": {"yemek": "Yeni Zelanda Pavlova", "ipucu": "Yumurta akı ve şekerden yapılan bezenin dışı çıtır, içi yumuşak olacak şekilde fırınlanıp meyveyle süslenmesidir."},
    "İzlanda": {"yemek": "İzlanda Hákarl", "ipucu": "Grönland köpebalığı etinin fermente edilip kurutulmasıyla yapılan geleneksel ve keskin kokulu yemektir."},
    "Danimarka": {"yemek": "Danimarka Smørrebrød", "ipucu": "Koyu çavdar ekmeği üzerine balık, et, peynir ve sebzelerin estetik bir şekilde dizilmesiyle yapılır."},
    "Norveç": {"yemek": "Norveç Lutefisk", "ipucu": "Kurutulmuş morina balığının sud ve sodyum hidroksit (kül suyu) karışımında yumuşatılıp fırınlanmasıdır."},
    "Finlandiya": {"yemek": "Finlandiya Karjalanpiirakka", "ipucu": "Çavdar hamurunun içine pirinç lapası doldurulup fırınlandıktan sonra yumurta yağı sürülerek yenmesidir."},
    "Bulgaristan": {"yemek": "Bulgaristan Banitsa", "ipucu": "İnce yufkaların arasına beyaz peynir ve yoğurtlu yumurta karışımı sürülerek spiral şekilde fırınlanmasıdır."},
    "Romanya": {"yemek": "Romanya Sarmale", "ipucu": "Lahana yapraklarının içine kıyma ve pirinç sarılarak fırın güvecinde domates sosuyla pişirilmesidir."},
    "Sırbistan": {"yemek": "Sırbistan Pljeskavica", "ipucu": "Dana ve kuzu kıymasının baharatlarla yoğrularak ızgarada büyük ve yassı köfte olarak pişirilmesidir."},
    "Hırvatistan": {"yemek": "Hırvatistan Crni Rižot", "ipucu": "Pirinç pilavının mürekkep balığı mürekkebiyle siyah renk alacak şekilde deniz ürünleriyle pişirilmesidir."},
    "Bosna-Hersek": {"yemek": "Bosna-Hersek Boşnak Böreği", "ipucu": "Elde açılan incecik yufkanın içerisine bol kıymalı veya patatesli harç koyularak spiral şekilde pişirilmesidir."},
    "Arnavutluk": {"yemek": "Arnavutluk Tave Kosi", "ipucu": "Kuzu etinin pirinç, yoğurt ve yumurta sosuyla güveçte fırınlanmasıyla yapılır."},
    "Kıbrıs Cumhuriyeti": {"yemek": "Kıbrıs Şeftali Kebabı", "ipucu": "Zırh kıyması, soğan ve maydanozun kuzu gömleğine sarılarak mangalda pişirilmesidir."},
    "Malta": {"yemek": "Malta Pastizzi", "ipucu": "Kat kat milföy hamurunun içine ricotta peyniri veya ezilmiş bezelye konularak üçgen fırınlanmasıdır."},
    "Lüksemburg": {"yemek": "Lüksemburg Judd Mat Gaardebounen", "ipucu": "Tuzlanmış domuz boynunun baklagiller ve kremalı sosla birlikte haşlanarak sunulmasıdır."},
    "Monako": {"yemek": "Monako Barbajuan", "ipucu": "İçi pazı, ricotta peyniri ve soğanla doldurulmuş hamur keselerinin derin yağda kızartılmasıdır."},
    "Andorra": {"yemek": "Andorra Escudella", "ipucu": "Et, sebze ve büyük makarnaların bir arada zengin bir çorba kıvamında haşlanmasıdır."},
    "Liechtenstein": {"yemek": "Liechtenstein Käsknöpfle", "ipucu": "Küçük ev yapımı hamur parçalarının erimiş peynir ve kavrulmuş soğanla karıştırılmasıdır."},
    "Moğolistan": {"yemek": "Moğolistan Boodog", "ipucu": "Keçi veya marmot etinin kemikleri çıkarılıp, içine kızgın taşlar doldurularak kendi içinde pişirilmesidir."},
    "Kazakistan": {"yemek": "Kazakistan Beşbarmak", "ipucu": "Geniş haşlanmış hamur şeritleri üzerine at veya kuzu etinin dizilerek özel soğan sosuyla yenmesidir."},
    "Özbekistan": {"yemek": "Özbekistan Özbek Pilavı", "ipucu": "Kazan içinde pirinç, kuzu eti, sarımsak, havuç ve kuyruk yağı ile uzun süre kavrularak pişirilir."},
    "Kırgızistan": {"yemek": "Kırgızistan Beshbarmak", "ipucu": "İnce açılmış el yapımı erişte hamurunun haşlanmış kuzu etiyle birlikte sunulmasıdır."},
    "Türkmenistan": {"yemek": "Türkmenistan İşlekli", "ipucu": "Kıymalı ve soğanlı iç harcın iki kat hamur arasında tandır fırınında pişirilmesiyle yapılan börektir."},
    "Tacikistan": {"yemek": "Tacikistan Kurutob", "ipucu": "Parçalanmış ekmeklerin üzerine keten tohumu yağı, yoğurt ve sebzelerin dökülmesiyle yapılan yemektir."},
    "Sri Lanka": {"yemek": "Sri Lanka Kottu Roti", "ipucu": "Özel unlu ekmeklerin (godamba roti) sebze ve etle birlikte metal sac üzerinde bıçakla vurularak doğranmasıdır."},
    "Afganistan": {"yemek": "Afganistan Kabul Pilavı", "ipucu": "Basmati pirincinin kuzu eti, karamelize havuç ve kuru üzümle birlikte fırınlanarak pişirilmesidir."},
    "Nepal": {"yemek": "Nepal Dal Bhat", "ipucu": "Mercimek çorbası ve pirinç pilavının yanında sebze köri turşusuyla birlikte servis edilmesidir."},
    "Butan": {"yemek": "Butan Ema Datshi", "ipucu": "Büyük acı yeşil biberlerin yerel eritilmiş y yak peyniri ve bol tereyağı ile pişirilmesiyle yapılır."},
    "Myanmar": {"yemek": "Myanmar Mohinga", "ipucu": "Balık suyu ve nohut unuyla koyulaştırılmış, pirinç noodle içeren geleneksel balık çorbasıdır."},
    "Laos": {"yemek": "Laos Larb", "ipucu": "Kıymalı etin nane, limon suyu, balık sosu ve kavrulmuş pirinç tozuyla karıştırılarak yapılan salatasıdır."},
    "Kamboçya": {"yemek": "Kamboçya Amok Trey", "ipucu": "Balık filetosunun hindistan cevizi sütü ve köri ezmesiyle karıştırılıp muz yaprağında buharda pişirilmesidir."},
    "Brunei": {"yemek": "Brunei Ambuyat", "ipucu": "Sagu nişastasının sıcak suyla karıştırılarak tutkal kıvamına getirilip ekşi soslara batırılarak yenmesidir."},
    "Doğu Timor": {"yemek": "Doğu Timor Ikan Asam", "ipucu": "Balık parçalarının demirhindi, domates ve yerel baharatlarla hafif ekşi sosta pişirilmesidir."},
    "Papua Yeni Gine": {"yemek": "Papua Yeni Gine Mumu", "ipucu": "Et, tatlı patates ve hindistan cevizi sütünün muz yapraklarına sarılarak kızgın taşlar üzerinde pişirilmesidir."},
    "Fiji": {"yemek": "Fiji Kokoda", "ipucu": "Çiğ balık etlerinin limon suyu ve hindistan cevizi sütünde, soğan ve biberle marine edilerek sunulmasıdır."},
    "Samoa": {"yemek": "Samoa Oka i Fafa", "ipucu": "Taro yaprakları ve balığın hindistan cevizi kreması içinde fırın güveçte pişirilmesidir."},
    "Tonga": {"yemek": "Tonga Lu Sipi", "ipucu": "Kuzu etinin soğan ve hindistan cevizi kreması ile taro yapraklarına sarılıp toprak fırında pişirilmesidir."},
    "Vanuatu": {"yemek": "Vanuatu Lap Lap", "ipucu": "Yersıcanı veya muz ezmesinin hindistan cevizi sütüyle karıştırılıp etle birlikte yapraklarda fırınlanmasıdır."},
    "Solomon Adaları": {"yemek": "Solomon Adaları Poi", "ipucu": "Meyve pürelerinin hindistan cevizi sütü ile karıştırılarak tatlı veya yan ürün olarak tüketilmesidir."},
    "Mikronezya": {"yemek": "Mikronezya Breadfruit", "ipucu": "Ekmek ağacı meyvesinin közde veya fırında pişirilerek patates benzeri nişasta kaynağı olarak yenmesidir."},
    "Marshall Adaları": {"yemek": "Marshall Adaları Kula", "ipucu": "Deniz ürünleri ve yerel kök sebzelerin hindistan cevizi yağı ile harmanlanarak pişirilmesidir."},
    "Palau": {"yemek": "Palau Taro Çorbası", "ipucu": "Taro bitkisinin kök ve yapraklarının hindistan cevizi sütüyle çorba kıvamında kaynatılmasıdır."},
    "Nauru": {"yemek": "Nauru Balık ve Hindistan Cevizi", "ipucu": "Taze okyanus balıklarının bol hindistan cevizi rendesi ve suyuyla hafif ateşte pişirilmesidir."},
    "Kiribati": {"yemek": "Kiribati Te Boi", "ipucu": "Kabak ve hindistan cevizi kremasının yoğunlaştırılmasıyla yapılan yerel bir çorba çeşididir."},
    "Tuvalu": {"yemek": "Tuvalu Pulaka", "ipucu": "Bataklıkta yetiştirilen taro benzeri kök bitkisinin hindistan cevizi sütüyle fırınlanmasıdır."},
    "Madagaskar": {"yemek": "Madagaskar Romazava", "ipucu": "Çeşitli etlerin yeşil yapraklı sebzeler ve zencefille birlikte sulu yemek olarak pişirilmesidir."},
    "Mauritius": {"yemek": "Mauritius Bol Reverse", "ipucu": "Çin ve Hint mutfağının karışımı olan, yumurtalı ve sebzeli kızarmış pirinç tabağıdır."},
    "Seyşeller": {"yemek": "Seyşeller Kari Zourit", "ipucu": "Ahtapot parçalarının hindistan cevizi köri sosu ve yerel baharatlarla pişirilmesidir."},
    "Komorlar": {"yemek": "Komorlar Langouste a la Vanilla", "ipucu": "Istakoz etinin vanilya aromalı özel sosla tatlandırılarak pişirilmesidir."},
    "Cibuti": {"yemek": "Cibuti Skudahkar", "ipucu": "Kuzu eti, pirinç, soğan ve kimyonun domates salçasıyla tencerede tek kapta pişirilmesidir."},
    "Somali": {"yemek": "Somali Canjeero / Sambar", "ipucu": "Süngerimsi gözleme benzeri ekmeğin mercian çorbası ve et suyuyla birlikte kahvaltıda yenmesidir."},
    "Eritre": {"yemek": "Eritre Tsebhi Zigni", "ipucu": "Acı berbere baharatı ve etle yapılan koyu kıvamlı bir yahni çeşididir."},
    "Sudan": {"yemek": "Sudan Aseeda", "ipucu": "Buğday unundan yapılan lapamsı hamurun üzerine etli ve bamya çorbası dökülerek yenmesidir."},
    "Güney Sudan": {"yemek": "Güney Sudan Kisra", "ipucu": "Darı unundan yapılan ince ekmeğin bamya bazlı yahnilere batırılarak tüketilmesidir."},
    "Uganda": {"yemek": "Uganda Luwombo", "ipucu": "Tavuk veya sığır etinin fıstık ezmesiyle karıştırılıp muz yaprağında buharda pişirilmesidir."},
    "Ruanda": {"yemek": "Ruanda Isombe", "ipucu": "Manyok yapraklarının ezilip patlıcan, fıstık ezmesi ve palmiye yağıyla pişirilmesidir."},
    "Burundi": {"yemek": "Burundi Ubwali", "ipucu": "Mısır veya sorgum ununun suyla pişirilerek katı hamur haline getirilmesi ve fasulyeyle yenmesidir."},
    "Zambiya": {"yemek": "Zambiya Nshima", "ipucu": "Mısır unundan yapılan kalın lapa hamurunun et ve soslu sebzelerle birlikte tüketilmesidir."},
    "Malavi": {"yemek": "Malavi Nsima", "ipucu": "Mısır ununun suyla kaynatılarak katı kıvama getirilen ulusal temel gıda ürünüdür."},
    "Zimbabve": {"yemek": "Zimbabve Sadza", "ipucu": "Beyaz mısır ununun suyla karıştırılıp katı top şeklinde pişirilerek soslarla yenmesidir."},
    "Botsvana": {"yemek": "Botsvana Seswaa", "ipucu": "Sığır veya keçi etinin tuzla birlikte yumuşayana kadar saatlerce haşlanıp didiklenmesidir."},
    "Namibya": {"yemek": "Namibya Potjiekos", "ipucu": "Döküm demir üç ayaklı tencerede açık ateşte pişen et ve sebze yahnisidir."},
    "Angola": {"yemek": "Angola Muamba de Galinha", "ipucu": "Tavuk etinin palmiye yağı (muamba), sarımsak, bamya ve acı biberle pişirilmesidir."},
    "Mozambik": {"yemek": "Mozambik Piri Piri Tavuk", "ipucu": "Tavuk etinin keskin acı piri piri biberi ve limon sosuyla marine edilerek mangallanmasıdır."},
    "Zambia": {"yemek": "Zambia Katogo", "ipucu": "Muz ve sakatatların veya etlerin hafif baharatlı sosta bir arada pişirilmesidir."},
    "Gabon": {"yemek": "Gabon Poulet Nyembwe", "ipucu": "Tavuğun palmiye fıstığı ezmesinden yapılan yoğun koyu sosla pişirilmesidir."},
    "Kongo": {"yemek": "Kongo Moambe", "ipucu": "Tavuk, palmiye yağı, sarımsak ve acı biberin güveçte kıvam alana kadar kaynatılmasıdır."},
    "K Kamerun": {"yemek": "Kamerun Ndole", "ipucu": "Acı yaprakların fıstık ezmesi, karides ve etle birlikte pişirilmesiyle yapılan ulusal yemektir."},
    "Ekvator Ginesi": {"yemek": "Ekvator Ginesi Succotash", "ipucu": "Mısır, fasulye ve sebzelerin tereyağı ile harmanlanarak pişirilmesidir."},
    "Orta Afrika Cumhuriyeti": {"yemek": "O.A.C. Kanda", "ipucu": "Kıyma toplarının yerel kabak çekirdeği ezmesi ve domates sosunda pişirilmesidir."},
    "Çad": {"yemek": "Çad Daraba", "ipucu": "Bamya, fıstık ezmesi ve domatesin sebzelerle birlikte püre kıvamında pişirilmesidir."},
    "Nijer": {"yemek": "Nijer Dambu", "ipucu": "İrmik veya mısır bulgurunun ıspanak ve et parçalarıyla buharda pişirilmesidir."},
    "Mali": {"yemek": "Mali Tiga Degu Na", "ipucu": "Fıstık ezmesi, kuzu eti, bamya ve patatesle yapılan yoğun kıvamlı bir yahni türüdür."},
    "Burkina Faso": {"yemek": "Burkina Faso Babgoussa", "ipucu": "Fasulye ve mısır ununun tatlı patatesle birlikte lapa halinde pişirilmesidir."},
    "Senegal": {"yemek": "Senegal Thieboudienne", "ipucu": "Balık, dolgulu pirinç ve sebzelerin domatesli özel sosta tek tencerede pişirilmesidir."},
    "Gine": {"yemek": "Gine Soumara", "ipucu": "Fermente edilmiş nitta tohumlarından yapılan özel baharatlı sosla et pişirilmesidir."},
    "Gine-Bissau": {"yemek": "Gine-Bissau Caldo de Mancarra", "ipucu": "Fıstık ezmesi bazlı, tavuk veya balık içeren koyu kıvamlı çorba yahnisidir."},
    "Sierra Leone": {"yemek": "Sierra Leone Yaprak Yahni", "ipucu": "Tatlı patates yapraklarının palmiye yağı ve balık veya etle pişirilmesidir."},
    "Liberya": {"yemek": "Liberya Palmiye Yağı Çorbası", "ipucu": "Taze palmiye yağı sıkacağından elde edilen özle etlerin kaynatılmasıdır."},
    "Togo": {"yemek": "Togo Djenkoume", "ipucu": "Mısır ununun domates ezmesi ve baharatlarla pişirilerek katı parça haline getirilmesidir."},
    "Benin": {"yemek": "Benin Kori", "ipucu": "Patates veya fasulyenin yerel baharatlar ve palmiye yağı ile kavrulmasıdır."},
    "Moritanya": {"yemek": "Moritanya Thieboudienne", "ipucu": "Balık ve sebzeli pirinç pilavının kurutulmuş balık aromasıyla zenginleştirilmesidir."},
    "Fildişi Sahili": {"yemek": "Fildişi Sahili Attieke", "ipucu": "Manyok yumrusunun fermente edilip rendelenerek kuskus tanelerine benzetilmesiyle yapılır."},
    "Bolivya": {"yemek": "Bolivya Salteña", "ipucu": "İçi et, patates, sebze ve hafif tatlı-baharatlı jöleli sosla doldurularak fırınlanan hamur işidir."},
    "Paraguay": {"yemek": "Paraguay Sopa Paraguaya", "ipucu": "Mısır unu, peynir, süt ve soğan karıştırılarak fırınlanan kek kıvamında tuzlu yemektir."},
    "Uruguay": {"yemek": "Uruguay Chivito", "ipucu": "İnce dana bonfile, domuz pastırması, peynir, yumurta ve mayonezli zengin sandviçtir."},
    "Guatemala": {"yemek": "Guatemala Pepián", "ipucu": "Kavrulmuş baharatlar, kabak çekirdeği ve susamla koyulaştırılmış tavuk veya et yahnisidir."},
    "Honduras": {"yemek": "Honduras Baleada", "ipucu": "Yumuşak mısır tortilla ekmeğinin içine fasulye ezmesi, peynir ve krema sürülerek katlanmasıdır."},
    "El Salvador": {"yemek": "El Salvador Pupusa", "ipucu": "Kalın mısır hamurunun içine peynir, fasulye veya domuz eti doldurularak ızgarada basılarak pişirilmesidir."},
    "Nikaragua": {"yemek": "Nikaragua Vigorón", "ipucu": "Haşlanmış yuka (manyok), çıtır domuz derisi kızartması ve lahana salatasıyla sunulur."},
    "Kosta Rika": {"yemek": "Kosta Rika Gallo Pinto", "ipucu": "Pirinç ve siyah fasulyenin soğan, biber ve özel Lizano sosuyla tavada kavrulmasıdır."},
    "Panama": {"yemek": "Panama Sancocho", "ipucu": "Tavuk, yerel yuka kökü ve kişnişle yapılan uzun süre kaynatılmış şifa çorbasıdır."},
    "Dominik Cumhuriyeti": {"yemek": "Dominik La Bandera", "ipucu": "Pirinç, kırmızı fasulye ve etin bir arada sunulduğu ulusal bayrak yemeğidir."},
    "Haiti": {"yemek": "Haiti Soup Joumou", "ipucu": "Kabak püresi, et, sebze ve makarnayla yapılan bağımsızlık sembolü geleneksel çorbadır."},
