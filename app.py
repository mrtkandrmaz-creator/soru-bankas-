...
# =========================================================
# 5. DİNAMİK VE MİLYONLARCA KOMBİNASYONLU SORU ÜRETİCİ (YAPAY ZEKA %75 & HAVUZ %25 HİBRİT)
# =========================================================
...
# =========================================================
# 6. EŞİT PAYLAŞTIRICILI VE KARIŞIK HİBRİT SORU LİSTESİ OLUŞTURUCU (%75 AI - %25 Havuz Mantığı)
# =========================================================
def ders_sirali_soru_uret(secilen_uniteler, hedef_sayi):
    ...
    # Bloklar halinde kalmasını önlemek ve tamamen homojen karışmasını sağlamak için çoklu karıştırma
    for _ in range(3):
    ...
    if st.sidebar.button("🚀 Hazırla ve Başlat", type="primary", use_container_width=True):
        if secilen_uniteler:
            ...
            for kalan_sn in range(tahmini_sure, 0, -1):
                ...
                status_box.info(
                    f"🤖 Soruların %75'i yapay zeka matrisinden, %25'i havuzdan harmanlanıp karıştırılıyor... "
                    f"Kalan tahmini süre: **{kalan_sn} saniye**"
                )
                time.sleep(1)
            
            # Hibrit & Karışık Soru Üretim Fonksiyonunu Çalıştır
            sorular = ders_sirali_soru_uret(secilen_uniteler, soru_sayisi)
            
            progress_bar.progress(100)
            status_box.success("✅ Hibrit sorular başarıyla hazırlandı ve karıştırıldı!")
            time.sleep(0.5)
